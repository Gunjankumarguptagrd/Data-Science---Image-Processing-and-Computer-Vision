...
img1 = cv2.imread('D:\DATA Science 360 DigiTMG\AI\avg.png',1)  
...
import cv2
img1 = cv2.imread("D:\DATA Science 360 DigiTMG\AI\loin.jpg",1)
img1 = cv2.resize(img1,(500,400))
print(img1)
cv2.imshow("Loin",img1)
cv2.waitKey()
cv2.destroyAllWindows()
############## Gray scal Image ##########

import cv2
img2 = cv2.imread("D:\DATA Science 360 DigiTMG\AI\loin.jpg",0)
img2 = cv2.resize(img2,(500,400))
print(img2)
cv2.imshow("Loin Gray Scal",img2)
cv2.waitKey()
cv2.destroyAllWindows()
...
import cv2
img3 = cv2.imread("D:\DATA Science 360 DigiTMG\AI\loin.jpg",-1)
img3 = cv2.resize(img3,(500,400))
print(img2)
cv2.imshow("Loin Colorful",img3)
cv2.waitKey()
cv2.destroyAllWindows()
