# -*- coding: utf-8 -*-
"""
Created on Mon Sep 26 23:02:22 2022
...
img = cv2.imread("D:\DATA Science 360 DigiTMG\AI\building.jpg")
...
#load image into gray scale
img = cv2.imread("D:\DATA Science 360 DigiTMG\AI\building.jpeg")
#img = cv2.resize(img,(600,700))
img_gray = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
