# -*- coding: utf-8 -*-
"""
Created on Sun Sep 25 17:57:27 2022
...
img = cv2.imread("D:\DATA Science 360 DigiTMG\AI\Color Balls.jpg",0)

_,mask = cv2.threshold(img, 70,255,cv2.THRESH_BINARY_INV)
kernal = np.ones((5,5),np.uint8)
e = cv2.erode(mask,kernal)

cv2.imshow("C_balls", img)
cv2.imshow("mask", mask)
